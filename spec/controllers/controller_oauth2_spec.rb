...
describe SorceryController, active_record: true, type: :controller do
  ...
  context 'with OAuth features' do
    ...
    %i[github google liveid vk salesforce paypal slack wechat microsoft instagram auth0 openid_connect].each do |provider|
  ...
  def stub_all_openid_connect_requests!
    ...
    allow_any_instance_of(Sorcery::Providers::OpenidConnect).to receive(:get_public_keys) { nil }
